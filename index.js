...
const { Client, LocalAuth, Buttons, List } = whatsappWebJS;
...
client.on('message_create', async (msg) => {
    ...
    if (msg.fromMe) {
        if (msg.body.startsWith('!toAllContactsOfGroup ')) {
            const GROUP_NAME = msg.body.split(' ')[1];
            ...
            if (group) {
                ...
                for (const contact of contacts) {
                    ...
                    const message = new Buttons(
                        `Olá! Sou o chatbot do admin do grupo ${GROUP_NAME}, estou entrando em contato pois estamos no inicio do semeste e precisamos limpar o grupo para adicionar novas pessoas... \n\n Ai gostaria de saber se você gostaria de continuar no grupo ${GROUP_NAME}?`,
                        buttons,
